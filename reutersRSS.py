...
# settings
rsstitle = ["reuters", "路透中文网"]
baseurl = "https://cn.reuters.com"
# 主页的xpath
pathstring = [
    '//div[@class="story-content"]/a/h3',
    '//*[@id="topStory"]//div[@class="story-content"]//a',
    '//*[@id="hp-wire"]//li//a'
]  # 右边栏,中间栏，实时新闻
# 子页的xpath
# subpathstring=['//div[@class="StandardArticleBody_body"]',]
subpathstring = [
...
# html0=etree.HTML(html.decode('utf-8','ignore'),etree.HTMLParser())
...
items = decrypter.getitems(baseurl, html, pathstring)
